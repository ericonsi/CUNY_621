...
qq <- EHExplore_Outliers_Boxplots(dfTeenGamb, "large")
qq1 <- EHExplore_Correlations_Scatterplots(dfTeenGamb, "gamble")
qq2 <- EHExplore_Distributions_Histograms(dfTeenGamb, size="large", nbins=50)
...
grid.arrange(grobs=def[c(1:5)],  ncol=2, nrow=3)
