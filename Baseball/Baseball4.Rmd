...
qq2 <- EHExplore_Distributions_Histograms(dfTeenGamb)

#zz <- EHExplore_CombineGraphs3(qq,qq2,qq1)

#grid.arrange(grobs=zz[c(1:15)], ncol=3, nrow=5)

grid.arrange(grobs=z4[c(2:11)],  ncol=3, nrow=5)

grid.arrange(grobs=qq[c(1:5)], ncol=5, nrow=1)
grid.arrange(grobs=qq1[c(1:5)], ncol=5, nrow=1)
grid.arrange(grobs=qq2[c(1:5)], ncol=5, nrow=1)
