...
x1 <- EHExplore_Correlations_Scatterplots(dfTrain, "TARGET_WINS")
x2 <- EHExplore_Correlations_Scatterplots(dfPH, "TARGET_WINS")

grid.arrange(x1[[2]], x2[[2]], ncol=2, top="Pitching_H Against Wins, All Records (leftt) and Hits Over 3000 (right)", bottom="Fig.6")
