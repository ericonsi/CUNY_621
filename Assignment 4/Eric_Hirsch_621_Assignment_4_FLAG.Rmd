...
df9Flag <- df8Flag %>%
  dplyr::select(-CAR_TYPE_Panel.Truck, -EDUCATION_Bachelors, -JOB_Home.Maker, -JOB_Doctor, -HOMEKIDS, -AGE, -YOJ, -OLDCLAIM, -EDUCATION_.High.School, -JOB_Clerical, -JOB_Student, -JOB_z_Blue.Collar, -RED_CAR_no, -CAR_TYPE_Van, -MVR_PTS, -MSTATUS_Yes, -EDUCATION_z_High.School)

EHModel_Regression_Logistic(df9Flag, "TARGET_FLAG", splitRatio = 1, xseed=10)
