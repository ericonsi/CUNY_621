...
library(caTools)
library(Metrics)
df5$SalePrice <- log(df5$SalePrice)
abc <- EHModel_Regression_StandardLM(df5, "SalePrice", splitRatio = 1)
```
...
summary(abc[[1]]$coefficients)


makePredictions2(abc[[1]]$coefficients)
