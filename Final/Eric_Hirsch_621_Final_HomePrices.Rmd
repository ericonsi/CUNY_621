...
There are mssing values scattered throughout the database.  We analyse them:

```{r}

mm <- EHSummarize_MissingValues(dfTrain)
...
A few categorical features like fireplace, fence, etc. take up the bulk of missings.  They do not appear to be important enough to retain so we delete them (FireplaceQu, Fence, Alley, MiscFeature, PoolQC, and LotFrontage).  We impute the mean for the rest.  Categorical NA's will be handled when we create our dummy variables. 
